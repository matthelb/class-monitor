...
class Section {
	...
	public $instructor;
	public $session;
	public $spacesAvailable;
	public $numberRegistered;
	...
	public function __construct($json_object, Course $course) {
			...
			$this->spacesAvailable = intval($json_object['spaces_available']);
			$this->numberRegistered = intval($json_object['number_registered']);
